""" test_suite_api_v2.py: This module contains fake tests for false REQRES API version 2."""
...
class TestSuite_APIv2:
    """ TestSuite_APIv2: This class contains fake tests for false REQRES API version 2. """
